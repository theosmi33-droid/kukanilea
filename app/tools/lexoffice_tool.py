...
class LexofficeUploadTool(BaseTool):
    ...
    domain = "accounting"
    entities = ["invoice", "customer", "voucher", "payment", "credit_note", "quotation", "order", "delivery_note", "contract", "reminder", "tax_rate", "account_balance", "bank_transaction", "expense", "revenue"]
