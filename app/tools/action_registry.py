...
class ActionRegistry:
    ...
    def register_tool(self, tool: BaseTool) -> None:
        for action in tool.actions():
            ...
            verb = str(action.get("verb") or action_id.split(".")[-1]).lower()
            ...
            is_destructive = verb in {"delete", "purge", "rollback", "cancel"}
            is_write = verb in {
                "create", "update", "upsert", "patch", 
                "execute", "execute_async", "import", 
            ...
            if is_destructive or (action.get("action_type") == "high_risk"):
                ...
                level = 3
            elif verb in {"list", "search", "get", "aggregate", "read"} or action.get("action_type") == "read":
                level = 1
