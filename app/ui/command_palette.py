...
async def command_palette_ui(request: Request):
    ...
    return templates.TemplateResponse("components/command_palette.html", {"request": request})
...
async def execute_command(
    ...
    if "kunden" in cmd or "crm" in cmd:
        return HTMLResponse("<div hx-get='/crm/' hx-trigger='load' hx-target='#main-content'>Navigiere zu CRM...</div>")
