...
def test_mail_summary_invalid_sla_hours_falls_back_to_default(client):
    resp = client.get("/api/mail/summary?sla_hours=not-a-number")
...
def test_mail_health_invalid_sla_hours_falls_back_to_default(client):
    resp = client.get("/api/mail/health?sla_hours=not-a-number")
