...
- Automation Builder (Phase 3): Eventlog-Trigger, Conditions-Allowlist, pending Actions mit Confirm-Gate, Replay-Schutz, CSRF, per-Rule Rate-Limits, Dry-Run und safe Export/Import (siehe `docs/AUTOMATION_BUILDER.md`).
