# KUKANILEA Vision Pack (For `@zentrale-debug`)

This folder contains the canonical vision and execution documents for the Sovereign-11 rollout.

## Recommended reading order
1. `KUKANILEA_TEAM_1PAGER.md`
2. `KUKANILEA_FINAL_MASTER_PLAN_v3.md`
3. `KUKANILEA_HARMONIE_INTEGRATIONSPFAD.md`
