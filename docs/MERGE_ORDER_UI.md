...
- `automation`: automation builder, pending and insight templates.
...
- `system_pages`: login/settings/visualizer level pages.
...
## Merge Queue
1. Domain-lane PRs (`dashboard`, `upload`, `automation`, `messenger`, `kalender`, `aufgaben_projekte`, `system_pages`) merge first.
