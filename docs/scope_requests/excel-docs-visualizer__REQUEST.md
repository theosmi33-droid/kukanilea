# Scope Request: excel-docs-visualizer
...
Without modifying these core files, the `excel-docs-visualizer` domain cannot comply with the Sovereign-11 architectural standards.
