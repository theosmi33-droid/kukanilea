...
def generate_provenance():
    ...
    provenance = {
        ...
        "subject": [{"name": "kukanilea-binary", "digest": {"sha256": "abcdef1234567890"}}],
        "predicateType": "https://slsa.dev/provenance/v1",
        "predicate": {
            "buildDefinition": {
                "buildType": "https://kukanilea.local/GenericPythonBuild@v1",
                "externalParameters": {"source": "github.com/theosmi33-droid/kukanilea"}
            },
            "runDetails": {
                "builder": {"id": "https://kukanilea.local/local-builder"},
                "metadata": {"invocationId": "inv-123", "startedOn": datetime.datetime.utcnow().isoformat() + "Z"}
            }
        }
    }
